# https://www.bilibili.com/video/av19574503?p=18
# pygame.display
import pygame,sys
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            print('[MOUSEDOWN]event.pos:',event.pos,' event.button:',event.button)
        if event.type == pygame.MOUSEBUTTONUP:
            print('[MOUSEUP]event.pos:',event.pos,' event.button:',event.button)
