...
class MainWindow():
    ...
    def create_dial_plate(self):
        ...
        pygame.draw.circle(self.screen,self.color_list[6],self.dial_rect.center,5)
    ...
    def clock_hand(self):
        ...
        width_h = 7
        # screen.fill((0,0,0))
        self.line(length_s,x,y,angle_s,color=(255,10,0),width = width_s)
        self.line(length_m,x,y,angle_m,color=(30,100,0),width = width_m)
        self.line(length_h,x,y,angle_h,color=(230,140,50),width = width_h)
        # pygame.display.update()
