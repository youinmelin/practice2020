...
class MainWindow():
    ...
    def __creat_snake(self, speed = 10):
        if not self.snake_list :
            ...
            body_x = self.snake_list[-1].rect[0] - self.snake_size
            body_y = self.snake_list[-1].rect[1] 
            self.snake_body = Snake(self.screen,[body_x, body_y, self.snake_size,self.snake_size]) 
        ...
        for e, rect in enumerate(self.snake_list):
            if e == 0:
                ...
                if self.direction == 'left':
                    x = self.snake_list[e-1].rect[0] + self.snake_size
                    ...
                    y = self.snake_list[e-1].rect[1] + self.snake_size
